                ...
                <section>
                    <div id="backgound">
                        <div id='order_transport_form'>
                            ...
                            <form  id="sing_up" method="post" action="controler/regis_controler.php?reg=105">
                                <label for="reg_name">Your fullname</label>
                                <input class="input" type="text" name="reg_name" <?php if((isset($line))&&($line==1))echo "id='bad'";?>/>
                                <br/>
                                <label for="reg_tel">Your's phone number </label>
                                <input class="input" type="tel" name="reg_tel" pattern="[0-9]{9}"<?php if((isset($line))&&($line==2))echo "id='bad'";?>/> 
                                <br/>
                                <label for="reg_email">E-mail</label>
                                <input class="input" type="email" name="reg_email" <?php if((isset($line))&&($line==3))echo "id='bad'";?>/>
                                <br/>
                                <label for="Password">Passsword</label>
                                <input class="input" type="password" name="reg_pass" maxlength="25" <?php if((isset($line))&&($line==4))echo "id='bad'";?>/>
